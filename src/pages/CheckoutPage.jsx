...
const CheckoutPage = () => {
  ...
  // const selectedAddressObj = addressList[selectAddress] || {}
  const selectedAddressObj = addressList.find((addr, index) => index === selectAddress) || {}

  console.log("Selected Address:", selectedAddressObj)
      ...
      const response = await Axios({
        ...
        data: {
          ...
          delivery_address: {
            ...
            mobile: selectedAddressObj.mobile || 0,
            address: selectedAddressObj.address_line || "-",
